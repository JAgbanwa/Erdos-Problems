# Internal audit protocol -- Paper II v1.1

Status: `NOT_STARTED`. Normative standard:
`../../../../../../INTERNAL_AUDIT_STANDARD_v1.2.md`.

The common v1.2 standard supersedes the generic v1.1 text formerly stored in
...
Apply gates `G0`--`G8` from the common v1.2 standard. Formal conformance is a
