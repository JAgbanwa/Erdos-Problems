...
## Main results
* `SimpleGraph.IsChordal.induce` — induced subgraphs of chordal graphs are chordal
...
private theorem avoidReach_iff_set (G : SimpleGraph V) (S : Finset V) (a b : V) :
  ...
  constructor <;> intro h <;> exact h.mono (by intro p q hpq; simpa using hpq)
...
theorem IsChordal.minimalSeparator_isClique [Fintype V] [DecidableEq V] (hG : G.IsChordal)
