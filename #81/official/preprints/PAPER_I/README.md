# Paper I — Official preprint release v1.3
...
This is the canonical public package for Paper I v1.3. It supersedes the public
...
- [English PDF](01_manuscript/PAPER_I_preprint_v1.3_en.pdf)
- [Spanish PDF](01_manuscript/PAPER_I_preprint_v1.3_es.pdf)
- [English Markdown](01_manuscript/PAPER_I_preprint_v1.3.md)
- [Spanish Markdown](01_manuscript/PAPER_I_preprint_v1.3_es.md)
- [Bilingual plain-language explainer](PaperI_explained_4_levels.html)
...
The final external residual report closes Paper I v1.3 with `PASS`; see
[`02_validation/02_IA_ADVERSARIAL_AUDITS/run_2026-08-21_v1.3_pkgfix/30_REPORT/FINAL_AUDIT_REPORT.md`](02_validation/02_IA_ADVERSARIAL_AUDITS/run_2026-08-21_v1.3_pkgfix/30_REPORT/FINAL_AUDIT_REPORT.md).
...
The paper proves the finite fractional inequality

```text
|E(G)| − 2·ν₃*(G) ≤ n²/6 + n
```

for split graphs. It does not establish an integral clique-partition theorem,
an asymptotic transfer theorem, a result for every chordal graph, or a
resolution of Erdős Problem #81.
