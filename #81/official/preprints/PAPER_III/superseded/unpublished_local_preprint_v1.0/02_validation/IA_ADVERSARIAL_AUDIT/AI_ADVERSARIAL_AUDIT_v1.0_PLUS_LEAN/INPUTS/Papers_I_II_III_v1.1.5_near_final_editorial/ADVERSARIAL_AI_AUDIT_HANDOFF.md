# External Adversarial AI Audit Handoff — Papers I–III v1.1.5

**Prepared:** 2026-07-28  
**Editorial state:** near-final candidate  
**Release verdict:** `EDITORIAL_DRAFT_WITH_OPEN_GATES`
...
| Sparse independent side | AX2 — Dross + Barber–Kühn–Lo–Osthus |
...
The v1.1.5 pass changed no mathematical content and no Lean source. See the changelog and semantic report.
...
1. update `README.md` to the v1.1.5 manuscript path;
2. update `DELIVERABLE_SPEC.md` to name the v1.1.5 input;
