...
BLOCKS = [
    ...
    ("Block 02", "Common-profile LP (Theorem 3.1 / E-3.1)", "block02_common_profile_LP",
     ...
     "Direct fractional triangle-packing LP (SciPy HiGHS) solved on the actual graph "
     "H(p,q,d) over the grid 3<=p<=8, 0<=q<=8, 0<=d<=p, and compared against the closed "
     "form F(p,q,d). Independent of the reduced 4-variable LP used in the proof.",
     "351/351 instances PASS (max |LP-F| = 3.9e-14)"),
