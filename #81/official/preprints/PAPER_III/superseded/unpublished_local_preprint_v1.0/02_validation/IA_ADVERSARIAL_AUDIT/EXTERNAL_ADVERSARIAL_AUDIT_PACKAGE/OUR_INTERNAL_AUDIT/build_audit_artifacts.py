...
BLOCKS = [
    ...
    dict(
        ...
        title=("Direct fractional triangle-packing LP on the actual graph H(p,q,d) (SciPy "
               ...
               "0<=q<=8, 0<=d<=p."),
        summary=[
            "- 351/351 instances: direct-graph LP optimum equals the closed form F.",
            "- Maximum |LP - F| over the grid = 3.9e-14 (solver float noise).",
        ],
        verdict="PASS (351/351 instances)",
    ),
    dict(
    ...
    dict(
        ...
        summary=[
            "- 372/372 instances satisfy 0<=Phi and 3*nu3<=|E|.",
