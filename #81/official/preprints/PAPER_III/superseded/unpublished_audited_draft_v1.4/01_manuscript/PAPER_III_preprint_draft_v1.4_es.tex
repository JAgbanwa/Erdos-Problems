...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Mapa esquemático de los tres regímenes de la demostración sobre el eje de parámetros \textbackslash alpha=q/p: el régimen escaso cerca de 0, el bulk alejado de ambos extremos y el corredor cercano al extremo cerca de 2.}]{figures/fig2_alpha_regimes_es.png}}
...
\textbf{Gates de release abiertos:} reproducción independiente; auditoría adversarial externa; revisión humana por pares; evaluación de arte previo que cubra trabajos recientes y en preparación; y publicación del tag y el commit públicos finales.
