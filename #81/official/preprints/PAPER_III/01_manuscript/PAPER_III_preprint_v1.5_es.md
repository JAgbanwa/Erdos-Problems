...
**Preprint:** versión 1.5. Este manuscrito y su artefacto formal adjunto forman el primer paquete público formal de preprint de Paper III.

**Fecha de publicación:** 23 de agosto de 2026  
**Estado:** preprint oficial del autor; auditado externamente por IA; sin revisión humana por pares. El desarrollo adjunto en Lean 4 / Mathlib es un freeze inmutable de fuentes. Una reproducción independiente e ininterrumpida compiló la raíz pública y las raíces de consulta y comprobó todas las superficies de axiomas designadas. La auditoría adversarial externa cerró con `PASS`. Las Secciones 11.6 y 13 delimitan con precisión el alcance y las limitaciones de esa evidencia. Esta publicación no sustituye una revisión humana por pares ni una determinación especializada de prioridad.
